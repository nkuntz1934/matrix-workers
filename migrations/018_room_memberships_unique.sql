-- Migration 018: Reinforce room operation race-condition guards (issue #009)
--
-- NOTE: This migration was originally numbered 017_room_memberships_unique.sql
-- but conflicted with 017_query_optimization_and_size_limits.sql. Renumbered
-- to 018 to ensure deterministic D1 migration ordering.
--
